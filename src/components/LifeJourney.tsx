              ...
              <div className={`max-w-lg w-full ${isLeft ? 'mr-auto pr-8 lg:pr-16' : 'ml-auto pl-8 lg:pl-16'}`}>
                ...
                >
                  ...
                  <div className="mb-6 absolute top-4 right-8 w-24 h-24 flex items-center justify-center">
                    ...
                    <div className={`relative w-16 h-16 rounded-xl bg-gradient-to-br ${step.color} bg-opacity-5 border border-white/10 backdrop-blur-sm flex items-center justify-center p-3 shadow-lg`}>
                      {step.visual === "UPick" ? (
                        // Custom text for UPick instead of logo
                        <div className="text-white font-bold text-xs leading-tight text-center opacity-90">
                          UPick
                        </div>
                      ) : (
                        <Image
