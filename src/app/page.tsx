  ...
  return (
    <>
      ...
      <main className="relative z-10 snap-y snap-mandatory h-dvh w-full overflow-y-scroll overflow-x-hidden">
        ...
        {/* PROJECTS */}
        <section id="projects" className="relative h-dvh snap-start flex items-center justify-center">
        ...
        <section id="about" className="relative snap-start min-h-dvh">
        ...
        <section id="skills" className="relative h-dvh snap-start flex items-center justify-center">
          <SkillConstellation />
        </section>
